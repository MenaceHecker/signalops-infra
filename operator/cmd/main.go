...
import (
	...
	"github.com/MenaceHecker/signalops-infra/operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "88ef6fa8.signalops.io",
	...
	if err := (&controller.RemediationPlanReconciler{
		...
		setupLog.Error(err, "unable to create controller", "controller", "RemediationPlan")
		os.Exit(1)
	}
