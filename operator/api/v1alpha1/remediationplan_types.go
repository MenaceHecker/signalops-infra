...
type RemediationPlanSpec struct {
	...
	// foo is an example field of RemediationPlan. Edit remediationplan_types.go to remove/update
	// +optional
...
type RemediationPlanStatus struct {
	...
	// conditions represent the current state of the RemediationPlan resource.
